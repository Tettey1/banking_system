...
LOCAL_APPS = [
    "Managers", 'Customers', "accounts", "deposits", "transactions",
    "withdrawals"
]
...
WSGI_APPLICATION = "CBS_API.wsgi.application"
...
AUTHENTICATION_BACKENDS = [
    ...
    # "Managers.custom_backend.AuthenticateCustomers",
